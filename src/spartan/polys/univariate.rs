//! Main components:
//! - `UniPoly`: an univariate dense polynomial in coefficient form (big
//!   endian),
//! - `CompressedUniPoly`: a univariate dense polynomial, compressed (omitted
//!   linear term), in coefficient form (little endian),
use std::{
    cmp::Ordering,
